...
package com.mycompany.aula101isidroexercicio2;
import java.util.Scanner;
public class Aula101IsidroExercicio2 {

    public static void main(String[] args) {
     Scanner teclado = new Scanner (System.in);
        
        int saqueInt, saqueDec;  
        int qtd100, qtd50, qtd20, qtd10, qtd2, qtd5, qtd1, qtd050, qtd025,
                qtd010,qtd005, qtd001;
